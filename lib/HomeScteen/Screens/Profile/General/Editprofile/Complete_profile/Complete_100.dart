...
class Complete_100 extends StatelessWidget {
  const Complete_100({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(onPressed: () { Get.to(Button_Nav_Bar()); }, icon: Icon(Icons.arrow_back),),
                ...
                Container(
                    ...
                    child: Stack(alignment: Alignment.center, children: [
                      Align(
                          ...
                          child: SizedBox(
                              ...
                              child: CircularProgressIndicator(
                                value: profilecontrol.progressVal,
                      ...
                      Align(
                          alignment: Alignment.center,
                          child: Text(
                            '${profilecontrol.percen} %',
                            style:TextStyle(fontSize: 23,
                                color: Static.botton),)),
                    ])),
                Text(
                  '${profilecontrol.completed_int}/4 Completed',style:
