...
class Complete75 extends StatelessWidget {
  const Complete75({super.key});
                ...
                Container(
                    ...
                    child: Stack(alignment: Alignment.center, children: [
                      Align(
                          ...
                          child: SizedBox(
                              ...
                              child: CircularProgressIndicator(
                                value: profilecontrol.progressV,
                      ...
                      Align(
                          alignment: Alignment.center,
                          child: Text(
                            '${profilecontrol.perceted} %',
                            style:TextStyle(fontSize: 23,
                                color: Static.botton),)),
                    ])),
                Text(
                  '${profilecontrol.complet}/4 Completed',style:
